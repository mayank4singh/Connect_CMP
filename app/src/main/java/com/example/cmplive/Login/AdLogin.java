...
public class AdLogin extends Fragment {
    View view;
    EditText mail, pass;
    Button log;
    TextView text;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.login_admin, container, false);
        mail = view.findViewById(R.id.Ademail);
        pass = view.findViewById(R.id.Adpass);
        text = view.findViewById(R.id.AdfrgtPass);
        log = view.findViewById(R.id.AdlogBtn);
                ...
                fAuth.signInWithEmailAndPassword(memail,mpass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(requireContext(), AdminDash.class));// Close login activity
                        } else {
                            pd.dismiss();
