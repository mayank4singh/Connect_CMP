...
public class AdStudent extends Fragment {
   ...
   View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ad_student, container, false);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.container,addStudent);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()){
                    ...
                    adapter = new StAdapter(list3,requireContext());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()){
                    ...
                    adapter = new StAdapter(list2,requireContext());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()){
                    ...
                    adapter = new StAdapter(list4,requireContext());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()){
                    ...
                    adapter = new StAdapter(list1,requireContext());
