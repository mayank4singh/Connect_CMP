...
public class UserAdpter extends RecyclerView.Adapter<UserAdpter.viewholder> {
    ...
    public UserAdpter(Chat chat, ArrayList<Users> usersArrayList) {
        this.chat=chat;
    ...
    public UserAdpter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(chat).inflate(R.layout.user_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull UserAdpter.viewholder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(chat, chatwindo.class);
